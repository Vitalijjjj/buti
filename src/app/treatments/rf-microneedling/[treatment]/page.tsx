/**
 * RF Microneedling Treatments - Dynamic Treatment Page
 *
 * Route: /treatments/rf-microneedling/[treatment]
 *
 * Dynamic routes for:
 * - doubletite
 * - doubletite-exosomes
...
export async function generateMetadata({
  ...
  const treatment = rfMicroneedlingTreatmentsData.treatments.find(
    (t) => t.id === treatmentId
  );
  ...
  return {
    title: `${treatment.title} Dublin | RF Microneedling Treatment | Facecult`,
    description: treatment.description,
    keywords: [
      `${treatment.title.toLowerCase()} Dublin`,
      `${treatment.title.toLowerCase()} Ireland`,
      "RF microneedling treatments Dublin",
    ...
    alternates: {
      canonical: `https://facecult.ie/treatments/rf-microneedling/${treatmentId}`,
    },
  };
}

export default async function RFMicroneedlingTreatmentPage({ params }: PageProps) {
  const resolvedParams = await params;
  const treatmentId: string = resolvedParams.treatment;
  ...
  const serviceSchema = {
    ...
    description: treatment.description,
    procedureType: "RF Microneedling Treatment",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 4,
        name: treatment.title,
        item: `https://facecult.ie/treatments/rf-microneedling/${treatmentId}`,
      },
    ],
  };
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="pt-28 pb-4 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex text-sm text-neutral-600">
              ...
              <Link href="/treatments/rf-microneedling" className="hover:text-primary-600">RF Microneedling</Link>
              <span className="mx-2">/</span>
        ...
        <div className="sticky top-20 z-30 bg-white border-b border-neutral-200 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex gap-2 overflow-x-auto scrollbar-hide py-4">
              {rfMicroneedlingTreatmentsData.treatments.map((t) => (
                <Link
                  key={t.id}
                  href={`/treatments/rf-microneedling/${t.id}`}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-xl text-primary-600 font-medium mb-6">
                  Professional RF Microneedling Treatment in Dublin
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-primary text-3xl sm:text-4xl font-bold text-neutral-900 mb-4">
                {rfMicroneedlingTreatmentsData.howItWorks.title}
              </h2>
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                {rfMicroneedlingTreatmentsData.howItWorks.description}
              </p>
            </div>

            <div className="grid md:grid-cols-4 gap-8">
              {rfMicroneedlingTreatmentsData.howItWorks.steps.map((step, index) => (
                <div
                  key={index}
        ...
        <section className="py-20 bg-gradient-to-b from-neutral-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <FAQAccordion faqs={rfMicroneedlingTreatmentsData.faqs} />
          </div>
        </section>
