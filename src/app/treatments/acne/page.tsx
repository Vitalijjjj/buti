      ...
      <section className="relative min-h-screen">
        <div className="grid lg:grid-cols-2 min-h-screen">
          ...
          <div className="relative flex items-center justify-center bg-gradient-to-br from-primary-100 via-accent-cream to-neutral-100 px-4 sm:px-6 lg:px-12 py-20">
            ...
            <div className="relative z-10 max-w-2xl">
              <h1 className="font-primary text-4xl sm:text-5xl lg:text-6xl font-bold text-neutral-900 mb-6 leading-tight">
                Acne Treatment in Dublin<br />
                <span className="text-primary-600">Clear, Confident Skin</span>
              </h1>

              <p className="text-xl sm:text-2xl text-neutral-700 font-light mb-4">
                Medical-Grade Acne Solutions
              </p>

              <p className="text-lg text-neutral-600 mb-8 leading-relaxed">
                Professional acne treatment solutions at Facecult Dublin. Advanced medical-grade treatments for clear, healthy skin.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <CTA
                  ...
                  variant="default"
                  data-analytics="cta-book-acne-hero"
                ...
                <CTA
                  ...
                  label="Contact Us"
                  variant="outline"
                  data-analytics="cta-contact-acne-hero"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <h3 className="font-semibold text-neutral-900 mb-1">Proven Results</h3>
                  <p className="text-sm text-neutral-600">Effective solutions</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-full min-h-[400px] lg:min-h-screen">
            <Image
              src="/assets/Hero.png"
              alt="Acne Treatment at Facecult Dublin"
              fill
          ...
          <Card className="bg-white shadow-2xl border-0 rounded-3xl overflow-hidden">
            <CardContent className="p-12 lg:p-16 text-center">
              ...
              <p className="text-xl text-neutral-600 max-w-2xl mx-auto mb-8">
                We&apos;re preparing comprehensive information about our acne treatment services. Contact us today to learn more about our solutions.
              </p>
              <CTA
                href="/book"
                label="Book Consultation"
                variant="default"
                data-analytics="cta-book-acne-coming-soon"
