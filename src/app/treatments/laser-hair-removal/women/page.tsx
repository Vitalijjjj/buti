/**
 * Laser Hair Removal for Women Page
 *
 * Route: /treatments/laser-hair-removal/women
 *
 * Features:
 * - Scrollable treatment area tabs (Bikini, Face, Upper Body, Lower Body, Full Body)
 * - Complete treatment details for each area
 * - How it works section
 * - Before/After results
 * - Expert testimonial
 * - FAQs
 * - SEO optimized for "laser hair removal for women Dublin"
 */
...
export const metadata: Metadata = {
  title: "Laser Hair Removal for Women Dublin | Permanent Hair Reduction | Facecult",
  description:
    "Professional laser hair removal for women in Dublin. Bikini, face, legs, underarms & full body. Permanent results with medical-grade technology. Book free consultation today.",
  keywords: [
    "laser hair removal for women Dublin",
    "bikini laser hair removal Dublin",
    "Brazilian laser Dublin",
    "leg laser hair removal Dublin",
    "facial hair removal women Dublin",
    "permanent hair removal Dublin",
    "laser hair removal Ireland",
  ],
  openGraph: {
    title: "Laser Hair Removal for Women Dublin | Facecult",
    description:
      "Say goodbye to razors and waxing forever. Professional laser hair removal for all areas. 80-95% permanent reduction. Book your free consultation.",
    type: "website",
    locale: "en_IE",
    siteName: "Facecult",
  },
  alternates: {
    canonical: "https://facecult.ie/treatments/laser-hair-removal/women",
  },
};

export default function LaserHairRemovalWomenPage() {
  // Convert treatment areas to match TreatmentArea type
  const treatmentAreas = laserHairRemovalWomen.treatmentAreas.map((area) => ({
    ...area,
  ...
  const serviceSchema = {
    ...
    name: "Laser Hair Removal for Women",
    description: laserHairRemovalWomen.description,
    ...
    howPerformed: laserHairRemovalWomen.howItWorks.description,
  };

  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: laserHairRemovalWomen.faqs.map((faq) => ({
      "@type": "Question",
      name: faq.question,
      acceptedAnswer: {
        "@type": "Answer",
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mt-8">
                  <div className="bg-primary-50 rounded-lg p-4">
                    ...
                    <p className="text-neutral-900 font-semibold">6-8 treatments</p>
                  </div>
                  ...
                  <div className="bg-primary-50 rounded-lg p-4">
                    ...
                    <p className="text-neutral-900 font-semibold">Every 4-6 weeks</p>
                  </div>
              ...
              <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src={laserHairRemovalWomen.heroImage}
                  alt={laserHairRemovalWomen.title}
                  fill
        ...
        {/* Before & After Results */}
        {laserHairRemovalWomen.beforeAfterImages && laserHairRemovalWomen.beforeAfterImages.length > 0 && (
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="font-primary text-3xl sm:text-4xl font-bold text-neutral-900 mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {laserHairRemovalWomen.beforeAfterImages.map((result, index) => (
